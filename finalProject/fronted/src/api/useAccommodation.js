 ...
 * @param {string|null} region - 지역 필터 (null = 전체)
 */
export const useAccommodations = (page = 1, size = 9, region = null) => {
  return useQuery({
...
/**
 * 숙소 상세 조회 훅
 * @param {number|string} accommodationNo - 숙소 번호
 */
export const useAccommodationDetail = (accommodationNo) => {
  return useQuery({
