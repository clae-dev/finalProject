                  ...
                  <div>
                    <div className="flex items-center justify-end gap-2 mb-2">
                      <button
                        ...
                        className="flex items-center gap-1.5 text-xs text-rose-400 hover:text-rose-500 font-medium transition-colors bg-rose-50 hover:bg-rose-100 px-3 py-1.5 rounded-full font-pretendard"
                      >
                ...
                {avatarMode === 'upload' && (
                  <div className="p-4 bg-gradient-to-br from-slate-50 to-sky-50/50 rounded-2xl border border-sky-100/60">
                    <label className="flex flex-col items-center justify-center w-full py-8 rounded-xl border-2 border-dashed border-sky-200 bg-white/60 cursor-pointer hover:border-sky-400 hover:bg-sky-50/50 transition-all duration-300 group">
                      ...
                      <span className="text-sm font-semibold text-slate-500 group-hover:text-sky-500 transition-colors font-pretendard"
                      >
                        {uploading ? '업로드 중...' : '클릭하여 이미지 선택'}
                      </span>
                      <span className="text-xs text-slate-400 mt-1 font-pretendard">
                        JPG, PNG, GIF (최대 5MB)
                      </span>
                      <input
                        ref={fileInputRef}
