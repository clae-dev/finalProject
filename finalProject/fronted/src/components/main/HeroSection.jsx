  ...
  return (
    <section className="relative h-[85vh] min-h-[600px]">
      ...
      <div className="relative z-10 h-full flex flex-col justify-center items-center text-center px-5">
        <p
          className="text-white/70 text-sm tracking-[0.3em] uppercase mb-6 font-pretendard"
        >
          Jeju Island Travel
        </p>

        <h1
          className="text-4xl md:text-6xl font-black text-white mb-4 leading-tight drop-shadow-lg font-gmarket"
        >
          파도 소리와 함께,
        
        </h1>
        <h1
          className="text-4xl md:text-6xl font-black mb-8 leading-tight drop-shadow-lg bg-gradient-to-r from-cyan-300 to-sky-300 bg-clip-text text-transparent font-gmarket"
        >
          나만의 시간
        </h1>

        <p
          className="text-lg text-white/80 mb-12 max-w-md leading-relaxed drop-shadow font-pretendard"
        >
          혼자여서 더 자유로운 제주 여행
        </p>
        ...
        <div className="flex gap-4">
          <button
            ...
            className="group px-8 py-3.5 bg-white text-sky-600 font-bold rounded-full shadow-xl hover:shadow-2xl hover:-translate-y-0.5 transition-all duration-300 flex items-center gap-2 font-pretendard"
          >
            숙소 둘러보기
          ...
          <button
            ...
            className="px-8 py-3.5 bg-white/15 backdrop-blur-sm text-white font-bold rounded-full border border-white/30 hover:bg-white/25 transition-all duration-300 font-pretendard"
          >
            동행 찾기
          </button>
        </div>
