      ...
      <div className="relative w-full max-w-md z-10">
        <div className="bg-white/95 backdrop-blur-xl rounded-3xl shadow-2xl shadow-sky-900/30 p-10 border border-white/50">
          ...
          <div className="space-y-3">
            ...
            <button onClick={handleNaverLogin} className="w-full h-12 flex items-center justify-center gap-3 bg-[#03C75A] hover:bg-[#02B350] text-white rounded-xl transition-all font-medium shadow-md hover:shadow-lg">
