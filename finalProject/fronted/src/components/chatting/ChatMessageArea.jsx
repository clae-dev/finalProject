      ...
      <div className="flex-1 overflow-y-auto px-4 py-4 bg-white">
        ...
        {messages && messages.length === 0 && (
          <div className="flex flex-col items-center pt-8 pb-6">
            {targetProfile ? (
              <img src={targetProfile} alt="" className="w-24 h-24 rounded-full object-cover border border-slate-200 mb-4" />
            ) : (
                ...
                <div className={`flex ${isMine ? 'justify-end' : 'justify-start'} ${showAvatar ? 'mt-3' : 'mt-0.5'}`}>
                  ...
                  {!isMine && (
                    <div className="w-8 mr-2 flex-shrink-0">
                      {showAvatar ? (
                        targetProfile ? (
                          <img src={targetProfile} alt="" className="w-7 h-7 rounded-full object-cover" />
                        ) : (
