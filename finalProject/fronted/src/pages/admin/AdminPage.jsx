...
import { Shield, LayoutDashboard, Users, FileText, Building2 } from 'lucide-react';
    ...
    <div className="min-h-screen bg-gradient-to-b from-sky-50 via-white to-cyan-50">
      ...
      <div className="max-w-6xl mx-auto px-5 -mt-6 relative z-10">
        <motion.div
          ...
          className="bg-white/80 backdrop-blur-xl rounded-2xl shadow-lg shadow-sky-100 border border-sky-50 p-2 flex gap-2 overflow-x-auto"
        >
          {TABS.map((tab) => {
            const Icon = tab.icon;
