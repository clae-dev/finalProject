      ...
      <div className="min-h-screen bg-gradient-to-b from-sky-50 via-white to-cyan-50">
        ...
        <div className="flex flex-col items-center justify-center py-40 gap-4">
          ...
          <button
            ...
            className="px-5 py-2.5 bg-gradient-to-r from-sky-400 to-cyan-400 text-white text-sm font-bold rounded-xl shadow-md"
      ...
      <div className="min-h-screen bg-gradient-to-b from-sky-50 via-white to-cyan-50">
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="flex flex-col items-center justify-center py-40">
          ...
          <button
            ...
            className="px-6 py-2.5 bg-gradient-to-r from-sky-500 to-cyan-500 text-white rounded-xl font-bold text-sm hover:shadow-lg transition-all"
            style={{ fontFamily: "'Pretendard', sans-serif" }}
          >
            로그인하러 가기
          </button>
    ...
    <div className="min-h-screen bg-gradient-to-b from-sky-50 via-white to-cyan-50">
      ...
      <div className="max-w-3xl mx-auto px-5 pt-24 pb-20">
        ...
        <motion.button
          ...
          onClick={() => navigate('/freeboard')}
          className="flex items-center gap-1.5 text-slate-400 hover:text-sky-600 transition-colors mb-6 group"
          style={{ fontFamily: "'Pretendard', sans-serif" }}
        >
        ...
        >
          ...
          <div className="px-7 pt-8 pb-6 border-b border-slate-100">
            <h1
              className="text-xl md:text-2xl font-black text-slate-900 leading-snug mb-5"
              style={{ fontFamily: "'Pretendard', sans-serif" }}
            >
              {board.boardTitle}
            </h1>
            ...
            <div className="flex items-center justify-between gap-4 flex-wrap">
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-sm font-bold text-slate-800" style={{ fontFamily: "'Pretendard', sans-serif" }}>
                ...
                <div className="flex items-center gap-2">
                  {isAuthor && (
                    <motion.button
                      ...
                      className="inline-flex items-center gap-1.5 px-3.5 py-2 bg-sky-50 text-sky-600 rounded-xl text-xs font-semibold hover:bg-sky-100 transition-colors border border-sky-100"
                      style={{ fontFamily: "'Pretendard', sans-serif" }}
                    >
                  ...
                  <motion.button
                    ...
                    className="inline-flex items-center gap-1.5 px-3.5 py-2 bg-red-50 text-red-500 rounded-xl text-xs font-semibold hover:bg-red-100 transition-colors border border-red-100"
                    style={{ fontFamily: "'Pretendard', sans-serif" }}
                  >
          ...
          <div className="px-7 py-7">
            <p
              className="text-[15px] text-slate-700 leading-8 whitespace-pre-wrap"
              style={{ fontFamily: "'Pretendard', sans-serif" }}
            >
              {board.boardContent}
            </p>
        ...
        >
          ...
          <div className="flex items-center gap-2 px-7 py-5 border-b border-slate-100">
            ...
            <h3 className="text-base font-black text-slate-800" style={{ fontFamily: "'Pretendard', sans-serif" }}>
              댓글
            </h3>
          ...
          <div className="px-7 py-4 border-b border-slate-100 bg-slate-50/50">
            <form onSubmit={handleCommentSubmit} className="flex items-center gap-2.5">
              ...
              <input
                ...
                maxLength={500}
                disabled={!user}
                className="flex-1 px-4 py-2.5 rounded-xl border border-slate-200 text-sm bg-white focus:outline-none focus:ring-2 focus:ring-sky-300 focus:border-sky-300 disabled:bg-slate-50 disabled:text-slate-300 transition-all"
                style={{ fontFamily: "'Pretendard', sans-serif" }}
              />
              <motion.button
                    ...
                    <div className="flex gap-3">
                      ...
                      <div className="flex-1 min-w-0 bg-slate-50 rounded-2xl px-4 py-3">
                        <div className="flex items-center justify-between mb-1.5">
                          <div className="flex items-center gap-2">
                            <span className="text-sm font-bold text-slate-800" style={{ fontFamily: "'Pretendard', sans-serif" }}>
                              {comment.memberNickname}
                            </span>
                            <span className="text-[11px] text-slate-400">{comment.createdAt}</span>
                          </div>
                        </div>
                        <p className="text-sm text-slate-700 leading-relaxed" style={{ fontFamily: "'Pretendard', sans-serif" }}>
                          {comment.content}
                        </p>
                        ...
                        <div className="flex items-center gap-3 mt-2">
                          {user && (
                            <button
                              ...
                              className="text-[11px] text-slate-400 hover:text-sky-500 font-semibold transition-colors"
                              style={{ fontFamily: "'Pretendard', sans-serif" }}
                            >
                              답글
                            </button>
                          ...
                          {user && Number(user.memberNo) !== Number(comment.memberNo) && (
                            <button
                              ...
                              className="text-[11px] text-slate-400 hover:text-orange-500 font-semibold transition-colors inline-flex items-center gap-0.5"
                              style={{ fontFamily: "'Pretendard', sans-serif" }}
                            >
                        ...
                        {replyTo === comment.commentNo && (
                          ...
                          >
                            ...
                            <input
                              ...
                              maxLength={500}
                              className="flex-1 px-3 py-2 rounded-xl border border-slate-200 text-sm bg-white focus:outline-none focus:ring-2 focus:ring-sky-300 transition-all"
                              style={{ fontFamily: "'Pretendard', sans-serif" }}
                          ...
                          <div key={reply.commentNo} className="flex gap-2.5">
                            ...
                            <div className="flex-1 min-w-0 bg-sky-50/60 rounded-2xl px-4 py-2.5 border border-sky-100/60">
                              <div className="flex items-center gap-2 mb-1">
                                <span className="text-xs font-bold text-slate-700" style={{ fontFamily: "'Pretendard', sans-serif" }}>
                                  {reply.memberNickname}
                                </span>
                                <span className="text-[10px] text-slate-400">{reply.createdAt}</span>
                              </div>
                              <p className="text-xs text-slate-600 leading-relaxed" style={{ fontFamily: "'Pretendard', sans-serif" }}>
                                {reply.content}
                              </p>
          ...
          >
            ...
            >
              ...
              <textarea
                ...
                maxLength={500}
                rows={3}
                className="w-full px-4 py-3 rounded-xl border border-slate-200 text-sm focus:outline-none focus:ring-2 focus:ring-orange-300 resize-none mb-4"
                style={{ fontFamily: "'Pretendard', sans-serif" }}
              />
              ...
              <div className="flex gap-2.5">
                ...
                <button
                  ...
                  className="flex-1 py-3 rounded-xl bg-gradient-to-r from-orange-500 to-red-500 text-white font-bold text-sm shadow-md shadow-orange-200/50 hover:shadow-lg transition-all disabled:opacity-50"
                  style={{ fontFamily: "'Pretendard', sans-serif" }}
                >
